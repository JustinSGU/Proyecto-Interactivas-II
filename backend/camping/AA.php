            ...
            <div class="activities-container">
                ...
                <?php
                    ...
                    echo "<div class='activity'>";
                        echo "<form class='form-container' action=''>"
                            ...
                            foreach($amenities as $index=>$amenity){
                                echo "<div class='form-items'>"
                                    ...
                                    ."</div>"
                                    ."<div>"
                                        ."<input id='am".$index."' data-index='".$index."' data-price='".$amenity["destination_amenity_price"]."' class='form-input' type='number' oninput='updateSubtotal(this)' name='am".$index."' step='1' value='0' min='0' max='50'>"
                                    ."</div>"
                                    ."<div>"
                            ...
                            foreach($tours as $index=>$tour){
                                echo "<div class='form-items'>"
                                    ."<div>"
                                        ."<label class='form-label destination-extra' for='tr".$index."'>".$tour["destination_activity_name"]."<span class='price-small'>($".$tour["destination_activity_price"].")</span></label>"
                                    ."</div>"
                                    ."<div>"
                                        ."<input id='tr".$index."' data-index='".$index."' data-price='".$tour["destination_activity_price"]."' class='form-input' type='number' oninput='updateTours(this)' name='tr".$index."' min='0' max='".$item[0]["camping_max_people"]."' step='1' value='0'>"
                                    ."</div>"
                                    ."<div>"
                                        ."<p id='tour".$index."'>$0</p>"
                                    ."</div>"
